    ...
    >
      ...
      <Box
        sx={{
          ...
          right: 0,
          bottom: 0,
          backgroundImage: 'radial-gradient(rgba(201, 99, 66, 0.1) 2px, transparent 2px)',
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              <motion.div variants={itemVariants}>
                <Box sx={{ position: 'relative' }}>
                  ...
                  {/* Floating labels side by side */}
                  <Box sx={{ position: 'absolute', top: -30, left: -20, display: 'flex', gap: 2 }}>
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  AI voice agents that sound human, work 24/7, and cost a fraction of traditional services
                </Typography>
              </motion.div>
              ...
              <Box 
                ...
                sx={{
                  ...
                  '&::before': {
                    ...
                    right: -2,
                    bottom: -2,
                    background: 'linear-gradient(45deg, #ff5900, #c96342, #5f007d)',
                    zIndex: -1,
                    borderRadius: '18px',
                    opacity: 0.5,
        ...
        >
          ...
          >
            ...
            >
              Trusted by over 500+ contractors nationwide to handle their customer communications efficiently and professionally
            </Typography>
            ...
            >
              {['24/7 Availability', 'Human-Like Conversations', 'Seamless Integration'].map((item, index) => (
                <motion.div
                  key={item}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
