...
const MoneyAnimation = () => {
  const moneySigns = Array.from({ length: 15 }, (_, i) => i);
...
const MoneyCounter = () => {
  ...
  return (
    ...
    >
      <Box component="span" sx={{ fontSize: '70%', opacity: 0.8, mr: 1 }}>-</Box>
      {formattedAmount}
    </Typography>
  );
};
        ...
        >
          <Box textAlign="center" mb={10}>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                <TrendingUpIcon sx={{ color: '#c96342', fontSize: 32 }} />
                <Typography
                  variant="h4"
                  component="p"
                  sx={{
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                ...
                >
                  Every unanswered call costs the average contractor $1,500-$3,000 in potential revenue
                </Typography>
              </Box>
            </motion.div>
          </Box>
            ...
            >
              <Box
                sx={{
                  ...
                  right: 0,
                  bottom: 0,
                  background: 'radial-gradient(circle at center, rgba(201, 99, 66, 0.05) 0%, transparent 70%)',
                  opacity: 0.7,
                }}
              />
              ...
              >
                {['5 missed calls = $15,000 lost', '10 missed calls = $30,000 lost', '20 missed calls = $60,000 lost'].map((text, i) => (
                  <Box
                    key={i}
                    component={motion.div}
