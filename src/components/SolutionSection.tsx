            ...
            <motion.div variants={itemVariants}>
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1, mb: 2 }}>
                  <VerifiedIcon sx={{ color: theme => theme.palette.primary.main, fontSize: 20 }} />
                  <Typography
                    variant="body1"
                    sx={{
                      fontWeight: 600,
                ...
                >
                  Our AI agents sound so human, customers often forget they're not talking to a real person. That's why we always identify ourselves as digital assistants upfront for full transparency and compliance.
                </Typography>
              </Box>
            </motion.div>
          </Box>
                ...
                >
                  <Box
                    sx={{
                      ...
                      width: '100%',
                      height: '100%',
                      backgroundImage: 'radial-gradient(circle at center, rgba(201, 99, 66, 0.05) 0%, transparent 70%)',
                      zIndex: 0
                    }}
                  />
                  ...
                  >
                    ...
                    >
                      <VolumeUpIcon sx={{ fontSize: 36, color: 'white' }} />
                    </Box>
                    ...
                    >
                      Listen to real conversations between HomeProven AI agents and potential customers. 
                      Notice how our agents handle objections, answer questions, and schedule appointments seamlessly.
                    </Typography>
